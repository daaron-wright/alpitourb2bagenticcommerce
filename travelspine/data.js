/* ============================================================
   ...
   traced end-to-end in under an hour. Anchored on the Travel Assistant
   orchestration blueprint + the Family A trip thread. Illustrative data.
   ============================================================ */
(function () {
  const D = {};
  ...
  /* ---------- Agency FE · AI-native decision canvas ----------
     The front end the agency drives (EasyBook · Travel Assistant). Plain-language
