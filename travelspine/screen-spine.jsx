...
(function () {
    ...
    return (
      <div style={{ marginBottom: 22 }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1.35fr", gap: 14, marginTop: 14, alignItems: "stretch" }}>
          <ChartCard title="What the agents watch" sub="Signal volume by source feed · one week. The Disruption agent reads EasyBook, Airline Partner OCC, hotelier portals and advisory feeds together.">
  ...
  function LiveCustomerEvents({ setScreen }) {
    const AG = {
      concierge: { n: "Travel Assistant Concierge", c: "#6B36A8", t: "#F0E6FA", icon: "chat-bot" },
    ...
    const EVENTS = [
      { evt: "EVT-7762", trace: "KAF-5B70-1180", cust: "Traveler Family A booking BK 88412 · wing closure hit Jaz Mirabel", ts: "live · 18:42",
        steps: [
          ...
          ["concierge", "Notified Partner Travel Agency: dates held at 14 Aug"],
        ] },
      { evt: "EVT-7758", trace: "KAF-5B70-1180", cust: "Traveler Family A changed the booking — grandparents joining, +2 pax", ts: "live · 09:21",
        steps: [
      ...
      { evt: "EVT-7770", trace: "KAF-5B70-1180", cust: "ATC strike risk on the Family A rotation", ts: "live · 14:05",
        steps: [
          ["supply", "Digital twin predicted a 4-hour re-time"],
          ["regradar", "No entry-rule impact on the re-time"],
          ["concierge", "Proactively notified Partner Travel Agency with a recovery option"],
        ] },
      { evt: "EVT-7741", trace: "KAF-9F2A-4471", cust: "Traveler Family A entry-rules case · EG e-visa update", ts: "live · 31 May",
        steps: [
          ...
          ["concierge", "Surfaced a proactive alert on the Family A booking"],
        ] },
    ];
    ...
    return (
      <div className="lce">
        ...
        <div className="lce-foot"><Icon name="information" size={12} /> The same events Partner Travel Agency sees in their booking experience — one record, both lenses. <a onClick={() => setScreen("flow")}>Open TravelRadar ↗</a> · <a onClick={() => setScreen("governance")}>PAC decisions ↗</a></div>
      </div>
    );
  }
      ...
      <div>
        <div className="page-head">
          <div>
            ...
            <div className="ph-sub">A small team of agents sits inside Travel Group's season-planning loop, watching every signal and acting only within the bounds Finance, Operations and Compliance have set. KAF runs the agents. PAC holds the rules. Every agent action asks the policy engine before it commits.</div>
          </div>
        ...
        <div className="pacrules">
          {[
            ...
            { id: "PROM-covenant-agency", bound: "Brand & promise", tone: "prod", policy: "A re-accommodation must preserve room class, board and family amenities for strategic-tier agencies." },
