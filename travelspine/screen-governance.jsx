...
(function () {
        ...
        <div className="panel" style={{ padding: "16px 14px" }}>
          <div className="ppc-graph">
            <div className="ppc-stage">
              ...
              <div className="ppc-shx">The selected Travel Group package at the centre.</div>
  ...
  const GUARDRAILS = [
    {
      id: "covenant", dec: "DEC-99412", rule: "PROM-covenant-agency", ref: "§7.1", result: "allow",
    ...
    },
    {
      ...
      logic: "commitment.exposure_gbp <= refund_exposure.headroom_gbp  // £310k",
      node: "PAC Controlled Action Check", up: "Tour-Ops Agent Analysis",
      branches: [{ l: "Action Level Determination", tone: "allow", taken: true }, { l: "Planner Evidence Screen", tone: "flag" }, { l: "Closed — Denied by Policy", tone: "deny" }],
    ...
    },
    {
      ...
      clause: "Automated actions are blocked while an affected Airline Partner rotation is mid-operation; outside it they may proceed.",
  ...
  function BindingGraph({ g, onJump }) {
    const STEPS = [
      ...
      { id: "pac", t: "PAC Controlled Action Check", s: "Policy gate before any commit", gate: true,
        pins: ["PROM-covenant-agency", "TRV-advisory-EG", "FIN-refund-exposure-EU", "FIN-margin-floor-IT"],
        ...
        <div className="panel" style={{ padding: 20 }}>
          ...
          <div className="gt-rail4">
            <div className="gt-stage paper">
              ...
              <div className="gt-doc"><Icon name="document-chart" size={13} /> Travel Group Tour-Operating Playbook · Summer EU</div>
  ...
  function ScreenGovernance({ toast, setScreen }) {
    ...
    const rows = D.audit.filter(r => filter === "all" ? true : filter === "brandt" ? r.customer === "Partner Travel Agency" : r.agent === filter);
          ...
          <UI.Collapsible title="Every decision, on the record" subtitle="One row per decision, traced to its playbook clause." badge={`${D.audit.length} records`}>
            <div className="panel" style={{ padding: 16, marginTop: 12 }}>
              <div className="audit-q">
                ...
                {[{ k: "all", l: "all decisions" }, { k: "pac", l: "agent: PAC" }, { k: "cost", l: "agent: yield" }, { k: "anomaly", l: "agent: disruption" }, { k: "brandt", l: "agency: Partner" }].map(f => (
