/* ============================================================
   ...
   Source of truth: travel_agentic_intelligence_platform_state_machine.json
   ============================================================ */
(function () {
  // Module → primary actor label shown on node cards
  const ACTOR = {
    "Platform": "Platform orchestrator",
    "Travel Assistant": "Travel Assistant agent",
  ...
  const META = {
    "Request Intake & Classification": { fn: "create_case_context", vals: ["package_recommendation", "itinerary_guidance", "regulatory_question", "proactive_rebooking", "ops_disruption", "regulatory_change", "unsupported"], brd: { sec: "1 Executive Summary / 3 Product Vision", id: "BRD-1", text: "The platform combines Travel Assistant, TravelRadar, and the Tour-Ops Agentic Spine into a governed intelligence layer for agency and internal workflows." } },
    "Identity & Account Scope Gate": { fn: "evaluate_account_permissions", vals: ["authorized", "limited", "unauthorized"], brd: { sec: "10.2 Travel Assistant Requirements", id: "BRD-BR015", text: "Travel Assistant must support account-specific answers only after authentication and authorization." } },
    ...
    "Customer Intent Branch": { fn: "validate_customer_workflow_scope", vals: ["package_recommendation", "itinerary_guidance", "regulatory_question", "proactive_rebooking"], brd: { sec: "8.1 Travel Assistant", id: "BRD-8.1", text: "Travel Assistant covers product selection, itinerary guidance, regulatory answers, order intelligence, multilingual support, and escalation." } },
    ...
    "Proactive Rebooking Analysis": { fn: "prepare_rebooking_or_alternative_prompt", vals: ["prompt_ready", "alternative_needed", "not_due_or_not_allowed", "route_sales"], brd: { sec: "12.5 Proactive Rebooking Workflow", id: "BRD-12.5", text: "Travel Assistant validates account permissions, checks availability/risk, PAC checks commercial and customer-specific rules, and routes quote, rebooking, or Sales workflow." } },
    ...
    "Regulatory Change Validation": { fn: "determine_policy_update_need", vals: ["validated", "rejected", "needs_legal_review"], brd: { sec: "9 Use Case 6", id: "BRD-9-UC6", text: "Regulatory team validates interpretation before PAC updates rules and Travel Assistant updates answers." } },
  ...
  const DESC = {
    "Request Intake & Classification": "Classify the incoming interaction into Travel Assistant, TravelRadar, tour-ops, rebooking, regulatory-change, or unsupported flow.",
    ...
    "Approved Source Retrieval": "Retrieve only approved, current Travel Group product, destination, regulatory and account sources for the classified request.",
    ...
    "Package Recommendation Analysis": "Extract trip requirements and rank candidate Travel Group packages with rationale and citations.",
