        ...
        {learned && (
          <div className="lrn-fromcx">
            <div className="lfc-head">
              ...
              <span className="lfc-trace">Partner Travel Agency · {D.event.trace}</span>
            </div>
            <div className="lfc-body">
              <div className="lfc-flow">
                <span className="lfc-step done"><Icon name="chat-bot" size={12} /> Partner Travel Agency set a preference in Travel Assistant</span>
              ...
              {lfc === "approved" ? (
                <div className="lfc-done">
                  ...
                  <div className="lfc-done-b">PROD-covenant-brandt updated · bundle re-tested (412 / 412 pass) · 1 new test case added. The next covenant-safe re-point for Partner Travel Agency auto-approves — no walkthrough, no agent retraining.</div>
                ...
                <div className="lfc-note">The customer's choice became a policy proposal automatically. Approve it and the next disruption for Partner Travel Agency resolves this way — no agent retraining, just a ratified rule.</div>
              )}
              {!lfc && (
