...
(function () {
  ...
  var APPS = {
    /* ---- Family beach holidays (Family Travel all-inclusive) ---- */
    family: {
      ...
      rules: rules([
        ...
        "Verified Partner Agency Network / partner agency account",
        "E-visa + passport validity checked per traveller",
        "Airline Partner or approved carrier · licensed transfer operator",
        "PTD info sheet + insurance terms on file",
        "New agency or 9+ pax group → trade-desk review",
      ]),
      scns: [
        { id: "a", out: "allow", title: "Repeat family, Partner Agency Network agency", sub: "Partner Travel Agency · verified · 2 adults + 1 child · EG",
          ev: ["pass", "pass", "pass", "pass", "pass", "pass", "pass"],
          verdict: "Hold released to booking.",
          body: "Entry documentation is already on file for the party and the agency is a verified Partner Agency Network member — every applicable rule clears with no human step.",
        ...
        { id: "c", out: "declined", title: "Unverified channel, undisclosed resale", sub: "Unverified channel · undisclosed group resale · advisory breach",
          ...
          body: "A family package cannot be released to an unverified channel for an undisclosed group resale into a corridor above the advisory threshold. The channel is referred to Travel Group partner verification.",
    ...
    /* ---- Adults-only escapes (Premium Travel) ---- */
    couples: {
      ...
      rules: rules([
        ...
        "Verified agency or direct Premium Travel channel",
      ...
      scns: [
        ...
        { id: "c", out: "declined", title: "Resale into restricted window", sub: "Unverified reseller · blackout window · undisclosed party",
          ev: ["block", "block", "block", "pass", "pass", "block", "block"],
          verdict: "Booking blocked.",
          body: "An unverified reseller cannot place an undisclosed party into a blackout window at a covenant-protected resort. The channel is referred to Travel Group partner verification.",
    ...
    /* ---- Guided tours (Signature Travel / signature journeys) ---- */
    tours: {
      label: "Guided tours",
      docs: [
      ...
      scns: [
        ...
        { id: "c", out: "declined", title: "Restricted route segment, unverified", sub: "Unverified channel · restricted country segment · no entry evidence",
          ...
          verdict: "Booking blocked.",
          body: "An unverified channel with no entry evidence cannot book a tour crossing a restricted route segment. The channel is referred to Travel Group partner verification.",
  ...
  var PRODUCTS = [
    { id: "jaz-mirabel", name: "Jaz Mirabel Beach", fam: "Family Travel", family: "All-inclusive family resort", app: "family",
      accent: "#0F766E", logo: null,
      tagline: "Shallow lagoon, shaded baby pool, Family TravelClub kids' club — the family flagship in Sharm.",
      meta: "PKG 31881 · Sharm el-Sheikh, EG · 7 nights · all inclusive",
      props: [["Rating", "4.6"], ["Nights", "7"], ["Board", "AI"]] },
    { id: "coral-bay", name: "Coral Bay Family Resort", fam: "Family Travel", family: "All-inclusive family resort", app: "family",
      accent: "#0E7490", logo: null,
    ...
    { id: "santorini-two", name: "Santorini for two", fam: "Premium Travel", family: "Adults-only escape", app: "couples",
      accent: "#E11B22", logo: null,
    ...
    { id: "bali-wellness", name: "Bali wellness retreat", fam: "Premium Travel", family: "Adults-only escape", app: "couples",
      accent: "#C2185B", logo: null,
    ...
    { id: "japan-signature", name: "Japan Signature Journey", fam: "Signature Travel", family: "Signature guided journey", app: "tours",
      accent: "#1E5BB8", logo: null,
    ...
    { id: "andalusia-ease", name: "Andalusia at ease", fam: "Signature Travel", family: "Signature guided journey", app: "tours",
      accent: "#2563EB", logo: null,
