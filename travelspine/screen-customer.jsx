/* ============================================================
   Customer FE — the Travel Group front door (slate utility bar,
   brand header, Travel Assistant search) with Travel Assistant as a slide-in
...
(function () {
  ...
  /* ---------- Travel Group front-door chrome ---------- */
      ...
      <div className="dow-util">
        <div className="dow-util-in">
          ...
          <div className="dow-util-r">
            ...
            <span className="dui"><Icon name="arrow-up-right" size={12} /> United Kingdom</span>
    ...
    return (
      <header className="dow-head">
        <div className="dow-head-in">
          <img className="dow-logo" src="assets/kyndryl-logo.png" alt="Kyndryl" onClick={onHome} style={{ cursor: "pointer" }} />
          ...
          <div className="dow-search">
            ...
            <button className="dow-ai-pill" onClick={onAsk}><span className="dow-spark">✦</span> Travel Assistant Beta</button>
  ...
  function DowFooter() {
    const cols = [
      ...
      { t: "CORPORATE", items: ["About Client Travel Group", "Careers", "Investors", "Airline Partner"] },
      ...
      <footer className="dow-foot">
        <div className="dow-foot-in">
          <div className="dow-foot-brand">
            <img className="dow-logo" src="assets/kyndryl-logo.png" alt="Kyndryl" />
        ...
        <div className="dow-foot-bar">
          <div className="dow-foot-bar-in">
            <span>© 1947–2026, Tour Operator</span>
            <span>®™ Trademark of Client Travel Group or an affiliated brand</span>
          </div>
        </div>
      </footer>
    );
      ...
      <div>
        ...
        <div className="dow-airow" onClick={onAsk} style={{ marginTop: 18 }}>
          <div className="dow-airow-l">
            ...
            <div className="dow-airow-h">Let Travel Assistant hold the right room for you.</div>
          ...
          <button className="dow-btn red" onClick={onAsk}><span className="dow-spark">✦</span> Hold via Travel Assistant</button>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="dow-buying">
        <div className="dow-side-card" style={{ maxWidth: 520 }}>
          ...
          <div className="dsc-b">Contact us for information about your agency account, or find a Partner Agency Network agency in your region.</div>
        ...
        <div className="dow-learnrow">Learn more about Travel Group's <a>net rates</a> and <a>booking processes</a>.</div>
      </div>
    );
  }
  ...
  function Storefront({ onAsk, onCart }) {
    ...
    return (
      <div className="dow-page">
        <div className="dow-crumbs">Holidays <span>›</span> Egypt · Sharm el-Sheikh <span>›</span> <b>Family Travel</b></div>
        <div className="dow-prod-head">
          <h1>Jaz Mirabel Beach · Family Travel All-Inclusive <span className="dow-star">☆</span></h1>
        ...
        <div className="dow-prod-body">
              ...
              <React.Fragment>
                <div className="dow-airow" onClick={onAsk}>
                  <div className="dow-airow-l">
                    ...
                    <div className="dow-airow-h">Not sure this is the right resort? Ask Travel Assistant.</div>
                    <div className="dow-airow-s">Describe the family and Travel Assistant selects, checks allotments &amp; entry rules, and sets up your hold — no forms.</div>
                  </div>
                  <button className="dow-btn red" onClick={onAsk}><span className="dow-spark">✦</span> Ask Travel Assistant</button>
                </div>
                <div className="dow-prose">
                  <p>The Family Travel flagship on Nabq Bay — a shallow private lagoon, a shaded baby pool, Family TravelClub with English-speaking staff, and family rooms a step from the water. All inclusive, with Airline Partner direct flights from London, Manchester and Edinburgh through the summer programme.</p>
          ...
          <aside className="dow-prod-side">
            <div className="dow-side-card">
              <div className="dsc-h">Net rates need an agency login.</div>
              <div className="dsc-b">Contact us about your agency account, or find a Partner Agency Network agency.</div>
              <div className="dow-cta-row" style={{ marginTop: 12 }}>
                <button className="dow-btn red sm">NET RATES</button>
                <button className="dow-btn red sm">HOW TO BOOK</button>
              </div>
            ...
            <div className="dow-side-ai" onClick={onAsk}>
              ...
              <div>
                <div className="dsa-h">Travel Assistant can book for you</div>
        ...
        {/* How Travel Assistant recommends — the recommendation decision graph */}
  ...
  function SearchResults({ query, onBack, onAsk, onCart }) {
    ...
    const results = [
      { n: "Jaz Mirabel Beach · Family Travel", d: "All-inclusive family flagship on Nabq Bay — shaded baby pool, Family TravelClub kids' club, family rooms by the lagoon." },
      { n: "Coral Bay Family Resort · Family Travel", d: "Family TravelClub resort with a strong kids' club and family rooms — solid availability across the summer programme." },
      { n: "Crete last minute · Value Travel", d: "Flexible departures with soft sloping sand and a gentle seabed — the budget-friendly family alternative." },
    ];
    return (
      <div className="dow-page">
        ...
        <div className="dow-srgrid">
          ...
          <div className="dow-srmain">
            <div className="dow-genanswer">
              ...
              <div className="dga-b">Family Travel all-inclusive resorts in Sharm el-Sheikh are built for families — shallow lagoons, shaded baby pools and English-speaking kids' clubs. For a toddler-first brief, <b>Jaz Mirabel Beach</b> leads on the baby-pool setup while staying inside a £3,500 family budget.</div>
              <div className="dga-foot">
                <button className="dow-btn red sm" onClick={onAsk}><span className="dow-spark">✦</span> Refine with Travel Assistant</button>
                <span className="dga-dis">AI-generated · may be incomplete. Review Travel Group's Data Privacy Notice & Terms.</span>
              </div>
            </div>
            {results.map((r, i) => (
    ...
    return (
      <div className="dow-cart-scrim" onClick={onClose}>
        <div className="dow-cart" onClick={e => e.stopPropagation()}>
          ...
          <div className="dow-cart-sub">Hold requests may carry a deposit after 72 hours. Your Travel Group contact will discuss with you if applicable.</div>
          ...
          <div className="dow-cart-body">
            {step === 0 && (
              <div className="dow-cart-item">
                <div className="dci-top"><Icon name="document-chart" size={14} /> <b>Jaz Mirabel Beach · Family Travel</b> <span className="dci-tp">Package No. 000000031881</span></div>
                <div className="dci-grid">
                  {[["Departure", "London · 14 Aug"], ["Party", "2 adults + 1 child (2)"], ["Board", "All inclusive"], ["Room", "Family · 72-h hold"]].map(([k, v]) => (
            ...
            {step === 1 && (
              <div className="dow-form">
                {[["First Name", "the travel advisor"], ["Reference", "Anonymous"], ["Phone", "+44 20 7946 0123"], ["Agency Name", "Partner Travel Agency"]].map(([l, v]) => (
                  <label className="dow-field" key={l}><span>{l}*</span><input defaultValue={v} /></label>
                ))}
                <label className="dow-field"><span>Departure airport*</span><select defaultValue="London (LHR)"><option>London (LHR)</option><option>Manchester (MAN)</option><option>Edinburgh (EDI)</option></select></label>
            ...
            {step === 2 && (
              <div className="dow-cart-confirm">
                ...
                <div className="dccf-b">We've received your hold request for Jaz Mirabel Beach. A confirmation has been sent to advisor@example.com. Request <b>P-2026-20418</b>.</div>
                <div className="dccf-ai" onClick={onAsk}><span className="ai-glyph" style={{ width: 14, height: 14 }} /> Next time, let Travel Assistant do this in one line — and track it live.</div>
              </div>
            )}
          </div>
  ...
  /* ---------- Travel Assistant flow (unchanged behavior) ---------- */
    ...
    return (
      <div className="cx2-decision fade-in">
        ...
        <div className="cx2-dec-pac">
          ...
          <WhyChip why={{ agent: "inventory", rule: "PROM-covenant-agency", brd: "Playbook §7.1 — a re-accommodation must preserve the booked room class, board and family amenities for strategic-tier agencies." }} label="How?" />
        </div>
            ...
            return (
              <div className={`cx-step ${s.state}`} key={i}>
                ...
                <div className="cx-card">
                  ...
                  {hasWhy && (
                    <div className="cxc-foot"><WhyChip why={s.why} /><span className="cf-note">agent · policy · the rule in Travel Group's operating playbook</span></div>
                  )}
                </div>
              </div>
            );
      ...
      <div className="cx2 cx2-canvas ca-flow" ref={scrollRef}>
        {mode === "alert" ? (
              ...
              <div className="ag-body">
                <div className="ca-alert">
                  ...
                  <div className="ag-say" style={{ marginTop: 8 }}>
                    Hello — a wing closure at Jaz Mirabel hit the room block behind the Family A booking. I'm re-pointing it to the Family TravelClub guaranteed block to protect the dates.
                  </div>
                  ...
                  <div className="ca-order">
                    ...
                    <div className="ca-ord-main">
                      ...
                      <div className="ca-ord-m">2 adults + 1 child · LHR → SSH · departs 14 Aug</div>
                    </div>
                ...
                <div className="cx2-parsed-note"><Icon name="information" size={12} /> {D.event.trace} is the same record Travel Group's planners are working from right now — the booking and their decision are one trace.</div>
              </div>
            </div>
          </div>
        ) : mode === "alts" ? (
          ...
          <div className="cx2-hello fade-in">
            <span className="eyebrow2"><span className="ai-glyph" style={{ width: 13, height: 13 }} /> Travel Assistant · {cx.account}</span>
            <h1>{cx.greeting}</h1>
            ...
            <div className="cx2-agent">
              ...
              <div className="ag-body">
                {intent === "build" ? (
                  <React.Fragment>
                    <div className="ag-say">
                      Got it — a <strong>family beach week with a two-year-old</strong>, mid-August from London. Here's what I read from your brief, no forms needed:
                    </div>
                  ...
                  <React.Fragment>
                    ...
                    <div className="ca-order" style={{ marginTop: 12 }}>
                      ...
                      <div className="ca-ord-main"><div className="ca-ord-n">BK 88412 · Jaz Mirabel Beach · departs 14 Aug</div><div className="ca-ord-m">Re-secured · 3 pax · LHR → SSH</div></div>
                    ...
                    <div className="cx2-parsed-note"><Icon name="information" size={12} /> Same record Travel Group's planners are working from · {D.event.trace}.</div>
                  </React.Fragment>
                ) : intent === "switch" ? (
                  <React.Fragment>
        ...
        <div className="cx2-composer-wrap">
          ...
          <div style={{ textAlign: "center", marginTop: 9, fontSize: 11, color: "var(--fg-subtle)" }}>
            Trace <span style={{ fontFamily: "var(--font-mono)" }}>{D.event.trace}</span> — same record Travel Group's planners work from · <span className="spruce-link" onClick={() => setLens("ops")}>see the operator view</span>
          </div>
        </div>
      </div>
    );
  ...
  /* ---------- Travel Assistant slide-in panel ---------- */
        ...
        <aside className={`ca-panel ${open ? "open" : ""}`} aria-hidden={!open}>
          <header className="ca-head">
            ...
            <div className="ca-head-t">
              <span className="ca-h1">Travel Assistant</span>
              <span className="ca-h2">Beta · powered by the agentic spine</span>
            </div>
            <button className="ca-x" onClick={onClose} aria-label="Close Travel Assistant"><Icon name="close" size={16} /></button>
          </header>
          <div className="ca-disclaimer"><Icon name="information" size={12} /> Answers are AI-generated and may not be complete or up to date. By using Travel Assistant you agree to Travel Group's Data Privacy Notice and Terms of Use.</div>
  ...
  /* ---------- Site-wide disruption banner (Partner Travel Agency) ---------- */
      ...
      <div className="dow-disrupt">
        <div className="dow-disrupt-in">
          ...
          <div className="ddx-tx">
            <b>Heads up, Partner Travel Agency —</b> a wing closure affected the room block behind the Family A booking. {secured ? "We re-secured the rooms and the 14-Aug dates hold." : "We're re-securing the rooms now to protect the dates."}
          </div>
  ...
  function OrderStatus({ naphtha, setNaphtha, toast, onAsk, onHome, goLearning }) {
    ...
    const PREFS = [
      ...
      { id: "call", t: "Always call the agency first", d: "Notify Partner Travel Agency before any re-accommodation.", delta: "mandatory agency-notify gate before commit" },
    ...
    function choosePref(p) {
      ...
      toast("Saved as a policy proposal — routed to your Travel Group policy owner.", { label: "See it in “Learned from you” →", onClick: () => goLearning && goLearning() });
    }
    const steps = [
      ...
      { t: "Rooms re-secured for you", d: "We moved the booking to the Family TravelClub guaranteed block so the closure wouldn't move the dates — same room class, same amenities.", state: "done", at: "06:34" },
      ...
      <div className="dow-page ord">
        ...
        <div className="ord-head">
          <div>
            ...
            <div className="ord-sub">Traveler Family A · via Partner Travel Agency · BK 88412 · Jaz Mirabel Beach</div>
          </div>
        ...
        <div className="ord-grid">
          <div className="ord-main">
            ...
            <div className={`ord-why ${why ? "open" : ""}`}>
              ...
              {why && (
                <div className="ord-why-body">
                  A wing closure affected the room block that holds the family's rooms. Travel Group re-secured the booking from the Family TravelClub guaranteed block and re-checked it against the agency covenant, so the departure dates didn't move. You don't need to do anything.
            ...
            <div className="ord-pac-card">
              ...
              {!pref ? (
                <React.Fragment>
                  <div className="opc-sub">Tell us how you'd like disruptions like this handled for your bookings. Your choice becomes a policy your Travel Group team reviews — then it just happens.</div>
                ...
                <div className="opc-proposed">
                  ...
                  <div className="opc-rule"><span className="opc-rule-id">PROM-covenant-agency</span> <span className="opc-plus">+ {pref.delta}</span></div>
                  ...
                  <div className="opc-note">A test case was generated and it's queued in the operator's “Learned from you” inbox. Once your Travel Group policy owner approves it, the next disruption resolves this way automatically — no waiting.</div>
            ...
            <div className="ord-decide">
              ...
              {acked ? (
                ...
                <React.Fragment>
                  ...
                  <button className="dow-btn ghost sm" onClick={onAsk} style={{ width: "100%", justifyContent: "center", marginTop: 8 }}>Request a change in Travel Assistant</button>
                </React.Fragment>
              )}
            </div>
            <button className="ord-ask" onClick={onAsk}><span className="ai-glyph" style={{ width: 14, height: 14 }} /> Ask Travel Assistant about this booking</button>
            {(naphtha.samples || []).length > 0 && (
              <div className="ord-samples">
                <div className="os-h"><Icon name="checkmark-filled" size={13} style={{ color: "var(--k-spruce-60)" }} /> Holds added via Travel Assistant</div>
  ...
  function ScreenCustomer({ toast, setLens, naphtha, setNaphtha, cxLanding, setCxLanding, goLearning }) {
    ...
    // entry leads with Travel Assistant surfacing the disruption (once per session, unless handed off to order)
    React.useEffect(() => {
      ...
      <div className="dowfe">
        ...
        {!assist && (
          <button className="ca-launch" onClick={openAssist}>
            <span className="dow-spark">✦</span> Ask Travel Assistant <span className="ca-launch-beta">BETA</span>
          </button>
        )}
