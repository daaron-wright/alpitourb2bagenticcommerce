...
export default defineConfig({
  ...
  build: {
    rollupOptions: {
      input: {
        // Root — Travel Assistant 2.0 Guided Demo (served at /)
        'index': resolve(__dirname, 'index.html'),
        // Travel Assistant Guided Demo (also reachable by filename)
        'guided-demo': resolve(__dirname, 'Travel Assistant 2.0 - Guided Demo.html'),
        ...
        // 'easybook': resolve(__dirname, 'EasyBook Next - Travel Assistant Workbench.html'),
        // 'platform': resolve(__dirname, 'Travel Group Platform.html'),
        // 'cohort': resolve(__dirname, 'Travel Group Synthetic Cohort.html'),
        // 'frontdoor': resolve(__dirname, 'Consumer Travel Portal - Travel Assistant Front Door.html'),
        // 'frontdoor-simple': resolve(__dirname, 'Consumer Travel Portal - Customer Front Door (Simple).html'),
        // 'concierge': resolve(__dirname, 'Travel Assistant B2B Concierge PoC.html'),
        // 'concierge-v2': resolve(__dirname, 'Travel Assistant B2B Concierge v2.html'),
        // 'spine': resolve(__dirname, 'Travel Group Operations on KAF.html'),
        ...
        // 'proposal': resolve(__dirname, 'Family A Proposal - Customer View.html'),
        // 'proposal-v1': resolve(__dirname, 'Family A Proposal - Customer View v1.html'),
        // 'deck': resolve(__dirname, 'Travel Group Travel Assistant 2.0 - Deck.html'),
        // 'flows': resolve(__dirname, 'Travel Group Travel Assistant 2.0 - Flows & Agentic Inventory.html'),
      },
    },
  },
});
