/* ============================================================
   ...
   Migrated from travel/easybook/data.js
   ============================================================ */
...
export const receipts: Record<string, any> = {
  ...
  cat1: { id: 'cat1', label: 'Family Travel catalogue 2026 · descriptive', sourceKind: 'catalogue', freshness: 'recent', checked: 'edition 2026/2', confidence: 'medium', reason: 'Descriptive enrichment — never overrides live inventory' },
...
export const offers: Record<string, any> = {
...
export const dashboard = {
  resume: [
    { id: 'WP-2231', title: 'Traveler Family A · Sharm el-Sheikh', meta: '2 adults + 1 child (2y) · 12–19 Aug · ≤ £3,500', stage: 'New lead · intake', hot: true },
    { id: 'WP-2228', title: 'Traveler F · Santorini', meta: '1 adult · September · boutique · awaiting customer decision', stage: 'Proposal shared · V2' },
    { id: 'WP-2219', title: 'Traveler Group G · ski week', meta: '12 pax · Scottish Highlands · January', stage: 'Quote draft' },
  ],
  holds: [
    { ref: 'AT-88102', title: 'Traveler D · Maldives · V1', expires: 'today 18:00', urgent: true },
    { ref: 'AT-88097', title: 'Traveler E · Tenerife · V3', expires: 'tomorrow 11:30' },
  ],
  signals: [
    { t: 'Sold-out recovered', s: 'Marchetti · Djerba — alternative accepted', kind: 'success' },
    { t: 'Modification self-served', s: 'Traveler E · Tenerife — dates moved, repriced −£60', kind: 'success' },
...
export const blockers = [
  { id: 'airport', label: 'Departure airport?', fix: 'London Heathrow', severity: 'blocking' },
