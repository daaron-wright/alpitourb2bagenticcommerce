/* ============================================================
   Travel Group Platform · traveler-side fixtures
   Migrated from travel/platform/traveler-data.js
   ============================================================ */
...
export const agency = { name: 'Partner Travel Agency', agent: 'Travel Advisor', city: 'London', phone: '+44 20 7946 0123' };

export const visualMatch = {
