/* ============================================================
   Travel Assistant B2B Concierge — chat panel + agent activity trace
   Migrated from travel/concierge/chat.jsx
   ============================================================ */
import React, { useEffect, useRef, useState } from 'react';
import { Ki } from './Components';

export function ChatPanel({ msgs, busy, chips, onChip, onSend, inputEnabled }: any) {
      ...
      <div className="cg-msgs" ref={scrollRef}>
        ...
        {busy && (
          <div className="cg-busy">
            ...
            Travel Assistant is orchestrating…
          </div>
        )}
      </div>
...
export function AgentTrace({ items }: { items: any[] }) {
