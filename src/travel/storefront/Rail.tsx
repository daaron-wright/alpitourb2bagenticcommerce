...
import { receipts, orchestrator } from './data';
import { Ki, Inf, SourceCard } from './Primitives';
import { AgentStatusBar, ToolCallCard, HandoffCard } from './Agentic';
import { BrandPick, RequestPick, ClusterMatch, NextBestAction, LiveFeed, ChoicesTimeline } from './Orchestrator';
  ...
  return (
    <div className={`sf-chatinq ${done ? 'done' : ''}`} data-screen-label="Incoming brief">
      ...
      <div className="ci-foot">
        <span className="ci-src"><Inf size={11} /> via Travel Concierge · Consumer Travel Portal</span>
        {done
        ...
        {tab === 'plan' && (
          <div className="sf-plan">
            <div className="sf-jtab">
              <div className="uc"><b>{(orchestrator as any).useCase.title}</b><span>One seamless touchpoint — the agent works, the customer experiences.</span></div>
