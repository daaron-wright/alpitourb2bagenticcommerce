/* ============================================================
   Travel Assistant Front Door — data + stages
   Migrated from travel/frontdoor2/data.js
   ============================================================ */
...
export const SCENARIOS: Record<string, any> = {
  cotswolds: {
    ...
    twc: {
      ...
      found: '42 packages across Travel Group, Family Travel & Premium Travel',
      composed: 'Flight · country estate · car · food tour',
      price: '£2,180 pp · all in',
    },
    soldOut: null,
    result: {
      brand: 'premium', brandName: 'Premium Travel', name: 'Cotswolds · 7 nights', sub: 'Cotswolds Country Estate · 12–19 October', match: 94,
      why: [['Mild in October', '14°C average'], ['1h50 from London', 'direct · Airline Partner'], ['Cotswolds food region', 'artisan cheese, bakeries and cider'], ['Boutique country estate', 'matches your past trips']],
      segs: [['arrow-up-right', 'Flight · Airline Partner', 'London LGW → Bristol · direct'], ['dashboard', 'Cotswolds Country Estate', '7 nights · breakfast · pool'], ['network', 'Hire car', '7 days · airport pick-up'], ['lightbulb', 'Food & wine day tour', 'Cotswolds · small group']],
      price: 2180,
    },
  },
  sharm: {
    ...
    twc: {
      ...
      details: ['2 adults + 1 child (2y)', '7 nights', 'all inclusive', 'from London'],
    ...
    result: {
      brand: 'family', brandName: 'Family Travel', name: 'Coral Bay Family Resort', sub: 'Sharm el-Sheikh · 12–19 August · all inclusive', match: 94,
      why: [['Baby pool + kids club', 'your detected preference'], ['Recovered from sold-out', 'closest family match'], ['Direct from London', 'Airline Partner · seats confirmed'], ['Within budget', '£250 under your cap']],
      segs: [['arrow-up-right', 'Flight · Airline Partner', 'London LHR → Sharm · direct'], ['dashboard', 'Coral Bay Family Resort', '7 nights · all inclusive · family room'], ['network', 'Private transfer', 'baby seat included'], ['lightbulb', "Kids club + baby pool", 'on site']],
      price: 3250,
    },
  },
  maldives: {
    ...
    twc: {
      ...
      found: 'Signature Travel & Travel Group premium inventory ranked',
      composed: 'Flight · overwater villa · seaplane · full board',
      price: '£3,980 pp',
    },
    soldOut: null,
    result: {
      brand: 'travel', brandName: 'Travel Group', name: "Maldives · Family Travel Premium Alimatha'", sub: 'Vaavu Atoll · 27 Dec–3 Jan · full board', match: 91,
      ...
      segs: [['arrow-up-right', 'Flight · Airline Partner 787', 'London → Malé · direct'], ['dashboard', 'Overwater villa', '7 nights · full board'], ['network', 'Seaplane transfer', 'Malé → Vaavu Atoll'], ['lightbulb', 'Diving package', 'house reef · 5 dives']],
      price: 3980,
    },
  },
};
