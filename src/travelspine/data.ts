/* ============================================================
   Travel Group Tour Operations on KAF — the agentic spine
   Migrated from travelspine/data.js — ES module export
   ============================================================ */
...
D.event = {
  ...
  atRisk: "Partner Travel Agency · BK 88412 · Traveler Family A",
...
D.agents = [
  {
    ...
    owns: "Airline Partner ops, hotelier, advisory and booking feeds",
  ...
  },
  {
    ...
    status: "active", now: "Re-pointing West wing → Family TravelClub guaranteed block", asks: "fill-rate targets + agency covenants",
  },
  {
...
D.agentRuns = {
  anomaly: {
    bound: "plant",
    steps: [
      { ph: "Plan", t: "Correlate the Jaz Mirabel allotment notice across the hotelier portal, booking platform and Airline Partner feeds." },
  ...
  inventory: {
    ...
    steps: [
      ...
      { ph: "Dispatch", t: "Score a West wing → Family TravelClub guaranteed-block re-point on fill rate and agency covenants." },
    ],
    checks: [{
      act: "Commit the re-point for the Partner Travel Agency covenant booking (Family A · 3 pax)",
      tool: "booking.repoint.write", rule: "PROM-covenant-agency", bound: "trade",
      ...
      result: "Re-point committed · 38 rooms → guaranteed block · Family A's 14-Aug date held",
...
D.bounds = [
  ...
  { id: "plant", n: 3, name: "Ops SOPs", icon: "network",
    desc: "Airline Partner rotations, crew & slot constraints, hotelier contracts, transfer ops.", rules: 38, owner: "Operations" },
...
D.connectors = [
  ...
  { id: "AVIATION", sub: "Airline Partner ops · OCC", io: "read" },
...
D.flow = [
  {
    ...
    pac: [{ rule: "OPS-SOP-rotation", result: "pass", note: "no Airline Partner rotation conflict on the affected dates" }],
  ...
  },
  {
    ...
    pac: [
      ...
      { rule: "PROM-covenant-agency", result: "pass", note: "agency covenant: room class + family amenities preserved on re-point" },
    ],
  ...
  },
  {
    ...
    erp: [
      "Re-point RP-20814 · West wing → Family TravelClub guaranteed block (38 rooms)",
      "Booking swap · BK 88412 Family A → guaranteed block, room class held",
...
D.brd = {
  name: "Travel Group Tour-Operating Playbook · Summer EU",
  file: "ALP-SOP-TO-EU-v3.1.pdf",
  version: "v3.1", signed: "M. Traveler F · Compliance · 24-May-2026",
  pages: 84, extracted: 198, compiled: 198, tests: 412,
  summary: "PAC reads the playbook Travel Group already runs the season on, extracts the underlying rules, and compiles them into executable policy — versioned, tested and signed off. The same artefact the reviewer reads is the one the runtime evaluates.",
  activities: [
  ...
  ontology: [
    ...
    { entity: "Departure", rel: "fulfils → Agency covenant", note: "Family Travel packages incl. Jaz Mirabel" },
...
D.firedRule = {
  id: "PROM-covenant-agency",
  name: "Partner Travel Agency agency covenant · room class + amenities preserved",
  decision: "allow",
  bound: "product",
  input: { agency: "Partner Travel Agency", booking: "BK 88412", package: "Jaz Mirabel Beach · Family Travel", repoint_to: "Family TravelClub guaranteed block", amenities_locked: true },
...
D.audit = [
  { id: "DEC-99412", at: "06:26:02", agent: "pac", action: "Evaluate re-point proposal", rule: "PROM-covenant-agency", result: "allow", chain: "Playbook §7.1 → covenant amenities match → allow", region: "EG", customer: "Partner Travel Agency", actor: "Allotment agent" },
...
D.customer = {
  name: "Traveler Family A",
  site: "London, UK · via Partner Travel Agency",
  po: "BK 88412 · Jaz Mirabel Beach",
  product: "Jaz Mirabel Beach · Family Travel all-inclusive",
  program: "Summer 2026 · Sharm el-Sheikh",
  qty: "2 adults + 1 child (age 2)",
  promised: "14-Aug-2026",
  promisedNow: "14-Aug-2026",
  statusHead: "On track — rooms re-secured, your dates are protected",
  contact: "Travel Advisor · Partner Travel Agency, London",
};

D.customerSteps = [
  {
    key: "ordered", phase: "Booking confirmed", state: "done", at: "21-May",
    plain: "Your week at Jaz Mirabel Beach was confirmed — family room, all inclusive, departing 14 August from London.",
  ...
  },
  {
    ...
    plain: "Rather than move your holiday, we re-secured your rooms from our guaranteed Family TravelClub block. Same resort, same room class, same baby pool, same dates.",
    why: { agent: "inventory", rule: "PROM-covenant-agency", brd: "Playbook §7.1 — a re-accommodation must preserve room class, board and family amenities for strategic-tier agencies." },
  },
  {
    key: "signoff", phase: "Final planner confirmation", state: "pending", at: "pending",
    plain: "An Travel Group duty planner is giving the adjustment a final one-click confirmation. Partner Travel Agency sees the locked confirmation the moment they do.",
...
D.outcomes = [
  { n: "01", line: "Quote turnaround", figure: "−50%", src: "Travel Assistant blueprint · Phase 1 target", why: "Automated search, ranking and proposal assembly across the seven-stage journey — quotes in minutes, not hours." },
  { n: "02", line: "Agent productivity", figure: "+30%", src: "Travel Assistant blueprint · target impact", why: "The right information and actions surfaced at each journey stage — more requests handled per agent per day." },
  { n: "03", line: "Proposal acceptance", figure: "+25%", src: "Travel Assistant blueprint · target impact", why: "Context + Recommendation agents apply persona signals — personalised itineraries aligned to client needs." },
  { n: "04", line: "B2B support escalations", figure: "−35%", src: "Travel Assistant blueprint · call-centre deflection", why: "Custom itinerary and modification workflows resolve complex requests without a ticket." },
];
...
D.queue = [
  ...
  { id: "EVT-2026-0789", title: "Covenant conflict · Marsa Select", sev: "critical", cat: "waiting",
    why: "Proposed re-point would drop the sea-view promise on a Premium Travel tier booking", state: "Blocked · planner required", val: "£240k",
  ...
  { id: "EVT-2026-0796", title: "Fuel surcharge change · EG routes", sev: "medium", cat: "routed",
    why: "Cost-to-serve up 4% on 6 Airline Partner routes after a surcharge revision", state: "Routed to Finance", val: "£180k",
  ...
  { id: "EVT-2026-0801", title: "ATC strike · regional airspace", sev: "medium", cat: "auto",
...
D.graph = {
  nodes: [
    { id: "cust", label: "Partner Travel Agency", type: "Agency", x: 50, y: 50, kind: "customer" },
    ...
    { id: "plantF", label: "Family TravelClub guaranteed block", type: "Allotment", x: 250, y: 210, kind: "plant" },
...
D.lims = {
  sample: "P-2026-20418",
  grade: "Jaz Mirabel Beach · Family Travel",
  lot: "Family TravelClub block · Sharm el-Sheikh",
  status: "In review",
  lineage: [
    { stage: "Requested", at: "10-Jun 06:35", note: "Travel Assistant · re-accommodation options composed", state: "done" },
...
D.cx = {
  greeting: "Hello — BK 88412 (Traveler Family A · Jaz Mirabel Beach, departing 14 Aug) is the live booking I'm watching. Ask me about it in plain language, or tell me what the family needs next. No forms.",
  account: "Partner Travel Agency · London, UK · Partner Agency Network Group",
  suggestions: [
    "Is the Family A 14-Aug departure still safe after the Jaz Mirabel wing closure?",
  ...
  exposure: [
    { sku: "Jaz Mirabel Beach", order: "BK 88412 · Family A · 3 pax", status: "Re-secured", tone: "spruce", note: "Moved to Family TravelClub guaranteed block · 14-Aug date held" },
  ...
  decision: {
    ...
    family: "Family Travel · all-inclusive family resort",
    confidence: 94,
    ...
    reasons: [
      ...
      "Family TravelClub kids' club with English-speaking staff, family rooms a step from the pool — directly on the 2024 trip they loved.",
      "Guaranteed Family TravelClub block means the rooms hold even through the West-wing closure, so the hold can be placed now.",
    ],
    regulatory: {
    ...
    availability: {
      state: "supply-aware",
      line: "Family room held in the Family TravelClub guaranteed block.",
    ...
    citations: ["Jaz Mirabel fact sheet · rev 5", "Family Travel family-resort selection guide", "TravelRadar · EG entry bundle v2026.05"],
    ...
    deliveryNote: "LHR → SSH · Airline Partner direct · within the family's window",
    pacState: "clear",
  ...
  requested: {
    ...
    did: [
      ...
      "Reserved the family room from the Family TravelClub guaranteed block",
    ],
  },
};
...
D.backtest = {
  ...
  rules: ["FIN-refund-exposure-EU", "TRV-advisory-EG", "PROM-covenant-agency", "FIN-margin-floor-IT"],
  versions: [
    {
      id: "v3.0", label: "v3.0", tag: "previous", live: false,
      verdict: "route", verdictLabel: "Route to planner",
      decisions: { "FIN-refund-exposure-EU": "allow", "TRV-advisory-EG": "allow", "PROM-covenant-agency": "route", "FIN-margin-floor-IT": "route" },
      conflicts: [],
      action: "No auto-action — every covenant-touching re-point waits for manual planner review.",
      doi: 81.3, doiDelta: "+0.0", transfer: "Held — manual queue", promise: "Traveler Family A loses the family room", risk: "£1.4M exposed while queued",
      summary: "Safe but slow. The re-point that protects the Family A booking sits in a manual queue; rooms stay unsold and the promise is at risk.",
    },
    {
      id: "v3.1", label: "v3.1", tag: "live", live: true,
      verdict: "allow", verdictLabel: "Allow in bounds",
      decisions: { "FIN-refund-exposure-EU": "allow", "TRV-advisory-EG": "allow", "PROM-covenant-agency": "allow", "FIN-margin-floor-IT": "flag" },
      conflicts: [],
      action: "Allotment agent commits the West wing → guaranteed-block re-point within bounds; planner confirms.",
      doi: 86.4, doiDelta: "+5.1", transfer: "Re-point RP-20814 committed (38 rooms)", promise: "Family A date held · 14-Aug", risk: "£0 exposed — promise protected",
    ...
    },
    {
      ...
      decisions: { "FIN-refund-exposure-EU": "allow", "TRV-advisory-EG": "allow", "PROM-covenant-agency": "allow", "FIN-margin-floor-IT": "deny" },
      conflicts: [
        {
          id: "CFL-014", a: "PROM-covenant-agency", b: "FIN-margin-floor-IT",
          text: "The covenant requires preserving the Family A room class + dates (→ guaranteed-block re-point). Draft v3.2 raises the summer margin floor so the guaranteed-block rooms fall below floor. No action satisfies both rules.",
      ...
      doi: 81.3, doiDelta: "+0.0", transfer: "Blocked — conflict unresolved", promise: "Traveler Family A loses the family room", risk: "£1.4M exposed · escalation required",
...
D.writePreview = {
  ...
  staged: [
    { sys: "EasyBook · booking platform", op: "Re-point RP-20814", detail: "West wing → Family TravelClub guaranteed block · 38 rooms · 14 departures", comp: "Reverse re-point + restore standard block", owner: "Duty planner · summer desk", risk: "low" },
    { sys: "EasyBook · booking platform", op: "Booking swap · BK 88412", detail: "Traveler Family A re-pointed to guaranteed block · room class held", comp: "Revert booking to standard allotment", owner: "Duty planner · summer desk", risk: "med" },
...
D.accountability = [
  ...
  { layer: "Decision boundaries", owner: "Domain owners · Planning · Airline Partner Ops · Trade desk · Finance · Compliance", color: "var(--k-warm-red-50)", tint: "var(--k-warm-red-10)", icon: "document-chart",
...
D.controls = {
  ...
  residency: {
    cite: ["opa"],
    rows: [
      { region: "EU", processing: "EU-resident path · London", pii: "Traveler names, rooming lists", masked: "Traveler identity masked in decision logs", retention: "Audit 7y · prompts 30d" },
...
D.learning = {
  inbox: [
    { id: "LRN-2041", kind: "skill", signal: "Planner override · approved covenant-safe re-point", from: "EVT-2026-0810 · Family A swap to guaranteed block", routed: "Policy owner + Digital Ops",
    ...
    { id: "LRN-2034", kind: "content", signal: "Agency asked an unsupported question", from: "Travel Assistant · cot + high-chair availability on arrival day", routed: "Concierge desk + content",
...
D.ontologyGraph = {
  ...
  nodes: [
    { id: "Agency", cat: "commercial" }, { id: "TravelAgent", cat: "commercial" }, { id: "TripIntent", cat: "commercial" },
    { id: "HoldRequest", cat: "commercial" }, { id: "Covenant", cat: "commercial" },
    { id: "Departure", cat: "product" }, { id: "Package", cat: "product" }, { id: "Document", cat: "product" },
    { id: "Resort", cat: "ops" }, { id: "Rotation", cat: "ops" }, { id: "Allotment", cat: "ops" }, { id: "Route", cat: "ops" },
    { id: "QuoteCase", cat: "quality" }, { id: "ConciergeTask", cat: "quality" }, { id: "Proposal", cat: "quality" }, { id: "FitResult", cat: "quality" },
    { id: "Playbook", cat: "governance" }, { id: "PolicyBundle", cat: "governance" }, { id: "PolicyRule", cat: "governance" },
    { id: "DecisionRight", cat: "governance" }, { id: "UserRole", cat: "governance" },
    { id: "Event", cat: "runtime" }, { id: "AgentRun", cat: "runtime" }, { id: "WritePreview", cat: "runtime" },
    { id: "BookingCommit", cat: "runtime" }, { id: "AuditRecord", cat: "runtime" },
  ],
  links: [
...
D.nba = [
  { id: "NBA-1", sev: "high", title: "Sign off the re-accommodation", lens: "ops", screen: "flow", cta: "Review & sign off",
    why: "3 booking writes are staged and reversible. The Family A 14-Aug date holds only once you release them." },
  ...
  { id: "NBA-5", sev: "info", title: "Notify Partner Travel Agency — rooms re-secured", lens: "cx", screen: "customer", cta: "See customer view",
...
D.spineCharts = {
  ...
  watch: {
    ...
    series: [
      ...
      { label: "Aviation · Airline Partner OCC", color: "#3E8AC2", fill: "rgba(62,138,194,.30)", data: [80, 95, 90, 110, 120, 55, 40] },
  ...
  regions: [
    ...
    { label: "EU · Coastal Europe", n: 9, color: "#E68A00" },
