/* ============================================================
   Alpitour Platform · traveler-side fixtures
   Migrated from alpitour/platform/traveler-data.js
   ============================================================ */
...
export const agency = { name: 'Rossi Travel', agent: 'Giulia Rossi', city: 'Bologna', phone: '051 123 4567' };
