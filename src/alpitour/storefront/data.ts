/* ============================================================
   ...
   Migrated from alpitour/storefront/data.js
   ============================================================ */

export const fmtEUR = (n: number): string => '€' + n.toLocaleString('en-IE');
...
export const BRIEF = 'The Carter family — 2 adults + 1 child (2 years) from Toronto — 10 days around Italy in August: Rome, Florence and the Amalfi Coast. They love food, history and slow mornings. Budget ≈ CA$11,000 (≤ €7,400 all-in). Non-negotiables: family rooms, air-con and short transfers.';
...
export const SF = {
  fmtEUR, brands, receipts, products, SHELVES, BRIEF, chips, blockers, addons,
  availability, PLAN, STAGE_LABEL, desk, pulse, priceCalendar, fitMatrix,
  milestones, overnight, tredi,
};
