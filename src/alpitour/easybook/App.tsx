/* ============================================================
   ...
   Migrated from alpitour/easybook/app.jsx
   ============================================================ */
import React, { useState, useRef } from 'react';
import { fmtEUR, dashboard, needs, blockers as defaultBlockers, STAGE_LABEL, offers } from './data';
import {
  ...
  function selectOffer(id: string) {
    ...
    orchestrate({
      ...
      then: () => {
        ...
        pushAgent(`Proposal <b>V1 is drafted</b> — ${offers[id].hotelName}, insurance and private transfer included: <b>${fmtEUR(3465)}</b>, your commission ${fmtEUR(416)}. Review it in the workspace. Placing a hold is a commercial commit, so <b>it needs your approval</b>.`, 'Proposal Composer');
