...
function AlHarvest({ ex }) {
  return (
    <Board phase="distill" time="01:45–01:53" title="Opportunity territories" output="Clustered & dot-voted territories"
      script="What did we discover today that was not in the demo? Cluster it into opportunity territories — then dot-vote the ones that would make Travel Group’s agentic future feel most differentiated.">
