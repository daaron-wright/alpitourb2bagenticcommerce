    ...
    >
      ...
      >
        ...
        <div className="relative z-10 p-4">
          ...
          {data.description && (
            <div
              className={`mt-2 text-xs font-medium leading-relaxed ${isExpanded ? "" : "line-clamp-2"}`}
              style={{ color: `${darkerColor}dd` }}
            >
              {data.description}
            </div>
          )}
                  ...
                  >
                    <ScrollableContent>
                      <pre style={{ margin: 0, whiteSpace: "pre-wrap" }}>
                        {JSON.stringify(mockInputSchema, null, 2)}
                      </pre>
                    </ScrollableContent>
                  </div>
                )}
              ...
              <div className="mb-2 rounded-md border" style={{ borderColor: `${baseColor}20` }}>
                ...
                {expandedSection === "output" && (
                  ...
                  >
                    <ScrollableContent>
                      <pre style={{ margin: 0, whiteSpace: "pre-wrap" }}>
                        {JSON.stringify(mockOutputSchema, null, 2)}
                      </pre>
                    </ScrollableContent>
                  </div>
                )}
