...
(function () {
  ...
  function JourneyStrip({ active }) {
    const steps = tredi.useCase.steps;
  ...
  function RequestPick({ chosen, onPick }) {
    ...
    return (
      <div className="sf-rq" data-screen-label="Incoming requests">
        {tredi.requests.map((r) => {
          const isB = r.id === "bianchi";
          const signals = isB && brief ? brief.answers.map((a) => a.v) : r.signals;
          const meta = isB && brief ? "via AlpiConcierge · cluster confirmed during inquiry · 24h hold" : r.meta;
          return (
  ...
  function ClusterMatch({ c }) {
    const hit = tredi.clusters.find((x) => x.id === c.cluster);
    return (
  ...
  function TurisandaPanel({ price, repriced, onGenMd, onSource }) {
    const j = tredi.japan;
    return (
      <section className="sf-turi" data-screen-label="Turisanda curated itinerary">
        ...
        <div className="tgrid">
          ...
          <aside className="side">
            ...
            <div className="incl">
              <div className="il">The package includes</div>
              {tredi.includes.turisanda.map((x) => (
  ...
  Object.assign(window, { SfSticky: Sticky, SfBrandPick: BrandPick, SfLiveFeed: LiveFeed, SfNextBestAction: NextBestAction, SfMdPreview: MdPreview, SfTurisandaPanel: TurisandaPanel, SfRequestPick: RequestPick, SfClusterMatch: ClusterMatch, SfClusterProgram: ClusterProgram, SfMapPanel: MapPanel, SfChoicesTimeline: ChoicesTimeline, SfJourneyStrip: JourneyStrip, SfJourneyBoard: JourneyBoard });
})();
