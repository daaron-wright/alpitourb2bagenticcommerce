/* ============================================================
   Alpitour Platform · traveler view (Alpitour.it) — English
   Airbnb-pattern, Shidoka-skinned. AlpiGPT sheet carries the
...
(function () {
  ...
  /* ============================================================
     AlpiGPT sheet — the B2B2C conversation
     ============================================================ */
  const QSEQ = [
  ...
  function TSheet({ open, onClose, b, inline, boot }) {
    ...
    function photoDone(skipped) {
      ...
      bus && bus.push("feed", { who: "traveler", t: "Sent a photo with the request — AlpiGPT is reading the preferences" });
      later(1600, () => {
    ...
    function confirmNeeds() {
      ...
      setTimeout(() => { bus && bus.push("feed", { who: "traveler", t: "AlpiGPT agentic search · 142 stays → 12 match → 3 fit the family profile" }); }, 3200);
      setTimeout(() => {
    ...
    function sendToAgency() {
      ...
      later(1400, () => {
        ...
        bus && bus.push("feed", { who: "traveler", t: "Request sent to Rossi Travel — with a 24h price lock" });
        push({ kind: "handoff" });
