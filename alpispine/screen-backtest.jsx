/* ============================================================
   ...
   Replay the allotment-disruption event under different PAC bundle versions.
      ...
      <div>
        <div className="page-head">
          <div>
            ...
            <div className="ph-sub">Replay the same allotment-disruption event under different PAC bundle versions before any of them reach production. See exactly how each version decides, where policies conflict, and what it does to inventory and the customer promise — a release gate, not a guess.</div>
          </div>
        ...
        {!ran ? (
          <div className="panel" style={{ padding: 40, marginTop: 16, textAlign: "center", color: "var(--fg-muted)" }}>
            <AiSpinner size={32} />
            <div style={{ marginTop: 10, fontSize: 13 }}>Replaying EVT-2026-0810 against {sel.id}…</div>
          </div>
        ) : (
        ...
        {bt && (
          <React.Fragment>
            <div className="spine-eyebrow" style={{ marginTop: 28 }}>
              ...
              <span className="se-r">The same allotment-disruption event, scored across six outcomes — and every rule's decision, version by version.</span>
            </div>
