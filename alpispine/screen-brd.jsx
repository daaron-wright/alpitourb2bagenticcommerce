...
(function () {
  ...
  function UploadGate({ onApply, toast }) {
    ...
    const SEED = [
      ...
      { name: "AlpiGPT_B2B_Orchestration_Blueprint.docx", size: "103 KB", kind: "Word document", at: "Draft · 11 May 2026", status: "Draft", tone: "violet" },
    ];
          ...
          <div className={`brd2-doc ${!compiled ? "compiling" : ""}`}>
            ...
            {compiled ? (
              ...
              <div className="panel-load">
                <span className="pl-label">Reading Alpitour's operating rules</span>
