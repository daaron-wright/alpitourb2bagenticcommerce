/* ============================================================
   ...
   evidence already attached. The allotment event routes to the flow.
   ============================================================ */
(function () {
      ...
      <div>
        ...
        <div className="panel ai-edge tint" style={{ marginTop: 18, padding: "13px 16px", display: "flex", gap: 12, alignItems: "center" }}>
          ...
          <div style={{ flex: 1, fontSize: 12.5, color: "var(--fg-1)", lineHeight: 1.5 }}>
            The allotment event is the one decision waiting on you. Everything else either cleared PAC automatically or was routed to the team that holds authority.
          </div>
          <Button variant="prim" onClick={goFlow}>Open EVT-2026-0810 →</Button>
        </div>
