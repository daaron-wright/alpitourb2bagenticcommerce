  ...
  function ScreenControls() {
    ...
    return (
      <div>
        ...
        {/* EVENT TAXONOMY */}
        <div className="spine-eyebrow" style={{ marginTop: 26 }}><span className="se-l">Event taxonomy</span><span className="se-r">One shared event language across EasyBook and third-party systems — every event carries a trace id and an idempotency key.</span></div>
