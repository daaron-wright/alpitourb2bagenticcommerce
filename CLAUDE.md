...
- Keep the slots as `<image-slot>` drop-targets in source so they stay fillable, and
  label each placeholder with what the genAI image should depict (e.g. "Coral Bay
  Family Resort — photo").
