/* ============================================================
   Consumer Travel Portal — Travel Assistant Front Door v2 (app)
...
(function () {
  ...
  function App() {
    ...
    const [scId, setScId] = useState("cotswolds");
    ...
    function run(id, typed) {
      const scenario = SCENARIOS[id] || SCENARIOS.cotswolds;
      setScId(scenario.id);
    ...
    function stageNarration(scenario, i) {
      ...
      if (i === 3) return "Searching across <b>Travel Group, Family Travel and Premium Travel</b> — ranked on fit, not just price.";
    ...
    const header = (
      <header className="v-head">
        <div className="v-head-in">
          <div className="v-logo" onClick={reset}>travel<small>WORLD · MOCK</small></div>
          <div className="v-brands">
            {["Travel Group", "Family Travel", "Premium Travel"].map((b, i) => <span key={b} className={`v-brandtab ${i === 0 ? "on" : ""}`}>{b}</span>)}
          </div>
          <div className="v-head-r">
            ...
            <span className="lk" onClick={() => showToast("WhatsApp stays — Travel Assistant is the line above it.")}><Ki name="chat-bot" size={13} /> WhatsApp</span>
      ...
      <div>
          ...
          <div className="v-value-in">
            ...
            <div className="v-value-grid">
              {[["−50%", "Time to a trip", "From describe to a ready-to-book proposal — minutes, not an afternoon of tabs."],
                ["3 → 1", "Brands, one answer", "Travel Group, Family Travel and Premium Travel searched together and ranked on fit."],
        ...
        <footer className="v-foot">
          <div className="v-foot-in">
            <b>Travel Assistant customer front door</b> · AI Lab mock — original layout inspired by consumer travel portal's structure & the KAF orchestration blueprint
        ...
        <div className="v-modal">
          ...
          <div className="v-modal-b">
            <div className="v-card v-twc" style={{ animation: "none" }}>
              <div className="v-twc-h"><Ki2 name="network" size={15} /> <span className="t">Travel Work Context</span><span className="id">wpkg_travel_001 · KAF</span></div>
              <div className="v-twc-rows">
                ...
                <div className="v-twc-row"><dt>Handoff to</dt><dd>Partner Travel Agency · Partner Agency Network Group · Gold</dd></div>
              </div>
            </div>
          ...
          <div className="v-modal-foot">
            ...
            <a className="v-btn teal" href="Travel Assistant B2B Concierge PoC.html"><Ki2 name="arrow-up-right" size={14} /> Open the agent's console →</a>
          </div>
        </div>
      </div>
    );
