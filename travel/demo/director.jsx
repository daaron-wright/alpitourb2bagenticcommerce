/* ============================================================
   Travel Assistant 2.0 — Guided demo · Demo Director (bottom command bar)
   Reads window.DemoBus (live agent stage) + window.PlatformBus
   (the Family A thread). Lights the matching beat, exposes the
...
(function () {
  ...
  const CAP_ROLE = {
    Travel Assistant: "interpret · orchestrate",
  ...
  function Director() {
    ...
    function seedInquiry() {
      ...
      PB.push("feed", { who: "traveler", t: "The Traveler Family A sent their inquiry to Partner Travel Agency." });
      ...
      <div className={`dd ${open ? "open" : ""}`}>
            ...
            {policy ? (
              <div className="dd-policy">
                ...
                <div className="dd-pol-foot">
                  ...
                  <a className="dd-kaf" href="Travel Group Operations on KAF.html?lens=ops&screen=governance" target="_blank" rel="noopener">Open in KAF governance ↗</a>
                </div>
              </div>
            ) : (
        ...
        <div className="dd-bar">
          ...
          <div className="dd-caps">
            ...
            {["Travel Assistant", "LyteAI", "Easybooking"].map((c) => {
