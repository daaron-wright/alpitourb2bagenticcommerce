/* ============================================================
   Travel Group Platform · shared trip thread (window.PlatformBus)
...
(function () {
  ...
  window.PlatformBus = {
    state: {
      ...
      accepted: false,  // the travel advisor accepted the handoff
  ...
  /* ---- cross-app bridge: Travel Group Operations on KAF (the spine) ----
  ...
  var THREAD_KEY = "travel.platform.thread";
  var SPINE_KEY = "travel.spine.event";
  var WF_KEY = "travel.agentic.activeWf";
