...
(function () {
  ...
  const { fmtGBP, dashboard, needs, blockers, STAGE_LABEL } = window.EB;
    ...
    function selectOffer(id) {
      ...
      orchestrate({
        ...
        then: () => {
          ...
          pushAgent(`Proposal <b>V1 is drafted</b> — ${window.EB.offers[id].hotelName}, insurance and private transfer included: <b>${fmtGBP(3465)}</b>, your commission ${fmtGBP(416)}. Review it in the workspace. Placing a hold is a commercial commit, so <b>it needs your approval</b>.`, "Proposal Composer");
