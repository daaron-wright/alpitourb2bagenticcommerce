/* ============================================================
   Consumer Travel Portal — Customer front door · simple Q&A
   One question at a time → one result → one handoff to the agency.
   Deterministic demo around the Traveler Family A scenario.
   ============================================================ */
(function () {
  ...
  const STATUS = ["Checking live availability with Travel Group…", "The most-loved family hotel is full for your week — finding better…", "Putting your trip together…"];
  ...
  function App() {
    ...
    function follow(kind) {
      ...
      if (kind === "agency") {
        ...
        later(700, () => push([
          { kind: "handoff" },
          { kind: "ai", html: "Sent. <b>Your advisor at Partner Travel Agency has everything</b> — your answers, the trip, the held price. You won't repeat a thing. He'll check the details and send you a full proposal, usually within the day." },
          { kind: "agency" },
        ]));
      }
    }
    ...
    function onSend() {
      ...
      push({ kind: "user", html: text });
      setQuery("");
      later(550, () => push([{ kind: "ai", html: "Happy to help with that when we're booking — for now you can <b>hold the trip free for 24 hours</b> or <b>send it to your travel agency</b>, and the travel advisor takes it from there." }, { kind: "follow" }]));
    }
        ...
        <div className="q-dock-in">
          <div className="q-inputrow">
            <input className="q-input" placeholder={started ? "Type your answer — or ask anything…" : "Describe the holiday you're imagining…"}
              ...
              onKeyDown={(e) => e.key === "Enter" && onSend()} disabled={working} aria-label="Message Travel Assistant" />
            <button className="q-send" disabled={working || !query.trim()} onClick={onSend} aria-label="Send"><Ki name="arrow-up-right" size={16} /></button>
          </div>
          <div className="q-dock-note">Travel Assistant answers only from Travel Group's own catalogues and live availability · hand to a human anytime.</div>
        </div>
      </div>
    );
    ...
    return (
      <div className="q-app">
        <header className="q-head">
          <div className="q-logo" onClick={() => location.reload()}>travel <span>· Travel Assistant</span></div>
          <div className="r">
        ...
        {!started && (
          <div className="q-start" data-screen-label="Front door start">
            <div className="q-start-in">
              ...
              <p className="q-foot-note">Answers grounded in Travel Group's own catalogues · your travel agency stays your agency.</p>
            </div>
          </div>
        )}
                  ...
                  <div className="body" style={{ width: "100%" }}>
                    <div className="q-card" data-screen-label="Result card">
                      ...
                      <div className="b">
                        ...
                        <div className="sub">Sharm el-Sheikh, Egypt · all inclusive · 7 nights in August · direct flight from London</div>
                        <div className="why">
                        ...
                        <div className="foot">
                          ...
                          <span className="verify" style={{ marginLeft: "auto" }}><span className="d"></span> Checked live with Travel Group just now</span>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                <div className="q-msg" key={i}>
                  ...
                  <div className="body" style={{ width: "100%" }}>
                    <div className="q-agency" data-screen-label="Agency handoff">
                      ...
                      <div>
                        <div className="t">Partner Travel Agency · Travel Advisor — your travel agency</div>
                        <div className="s">12 Market Street, London · +44 20 7946 0123. Your booking, payment and any changes stay with the travel advisor — Travel Assistant just did the legwork.</div>
                        <div style={{ marginTop: 10 }}>
                          <a className="q-btn" style={{ fontSize: 13, padding: "9px 16px", minHeight: 0 }} href="Family A Proposal - Customer View.html">See the proposal the travel advisor sends back →</a>
                        </div>
                      </div>
                    </div>
                  </div>
