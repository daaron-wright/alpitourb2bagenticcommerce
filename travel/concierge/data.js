/* ============================================================
   Travel Assistant B2B Concierge — mock data (no real APIs)
   ============================================================ */
window.CG = (function () {
  const agency = {
    id: "agency_partner_travel",
    name: "Partner Travel Agency",
    tier: "Gold Partner",
    commissionRate: 12,
    preferredBrands: ["Premium Travel", "Travel Group"],
    channel: "EasyBook",
  };
  ...
  const hotels = {
    jaz: {
      id: "jaz", name: "Jaz Mirabel Beach", destination: "Sharm el-Sheikh", brand: "Travel Group",
    ...
    coral: {
      id: "coral", name: "Coral Bay Family Resort", destination: "Sharm el-Sheikh", brand: "Travel Group",
    ...
    redsea: {
      id: "redsea", name: "Red Sea Palm Village", destination: "Sharm el-Sheikh", brand: "Premium Travel",
    ...
    sinai: {
      id: "sinai", name: "Sinai Blue Lagoon Resort", destination: "Sharm el-Sheikh", brand: "Travel Group",
  ...
  const flight = {
    route: "London Heathrow → Sharm el-Sheikh",
    carrier: "Airline Partner", code: "NO 7714 / NO 7715",
  ...
  // KAF phase per blueprint: Discover → Plan → Validate → Commit
  const KAF = {
  ...
  return { agency, customer, requirements, hotels, flight, addOns, policies, KAF, fmtGBP };
})();
