/* ============================================================
   ...
   ============================================================ */
(function () {
  const { fmtGBP, receipts } = window.SF;
  ...
  /* Travel Concierge identity mark — the infinity symbol (Client Travel Group) */
  ...
  /* Travel Concierge panel-render loader — the DS canonical "Panel render" (ai-loader.html):
