...
(function () {
  ...
  function JourneyGraph({ mode, versions, holdRef, signaturePrice, signatureRepriced, mdGenerated, mdSent }) {
    const d = orchestrator.journey[mode];
    ...
    if (mode === "signature" && signatureRepriced) {
      prices = d.prices.map((v, i) => (i === d.repriceIdx ? signaturePrice : v));
    }
      ...
      const datasets = [
        {
          ...
          fill: true, tension: 0.35, pointRadius: prices.map((_, i) => (mode === "signature" && signatureRepriced && i === d.repriceIdx ? 5 : 0)),
      ...
      chartRef.current = new Chart(canvasRef.current, {
        ...
        options: {
          ...
          plugins: {
            ...
            tooltip: { backgroundColor: "#0F172A", padding: 10, cornerRadius: 4, callbacks: { label: (c) => c.dataset.label.split(" · ")[0] + ": " + fmtGBP(c.raw) } },
