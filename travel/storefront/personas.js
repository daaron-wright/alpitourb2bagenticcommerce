/* ============================================================
   ...
   interrogate at any point to validate the Travel Concierge 2.0 demo.
...
(function () {
  ...
  var DEMO = "You are taking part in a live validation of the Travel Concierge 2.0 demo for Client Travel Group. " +
    "Travel Concierge 2.0 turns Travel Concierge from a Q&A bot into an agentic system that runs a travel agent's whole sales workflow on one screen. " +
    "Travel Orchestrator is the intelligent supervisor; it coordinates specialist experts — Hotel Specialist (live availability), Tour Specialist (compiles & prices packages), Destination Specialist (country/culture notes) — over live inventory, pricing and policy. " +
    "Worked example: Traveler Family A (2 adults + a 2-year-old, from Toronto) want 10 days around the United Kingdom in August — London, Bath, Cornwall, ~CA$11,000, family rooms + air-con + short transfers. The preferred hotel is sold out, so Travel Concierge recovers the sale with ranked alternatives, writes a proposal.md (one document rendering to email/SMS/notification/trip-page), places a gated hold, services a date change, and recovers a mid-trip disruption (Cornwall road closed → re-routed via Plymouth + private ferry, with a goodwill upgrade). " +
    "It runs on the Kyndryl Agentic Framework (KAF): destructive tools always gate on the human agent, every action has provenance, policy is enforced as code. Capability footer: Travel Concierge · LyteAI · Easybooking.";

  var PEOPLE = [
    {
      id: "platform", code: "P-DEMO-01", idx: 1,
      name: "Platform Executive", role: "CIO · Client Travel Group",
      ...
      bio: "This platform executive owns the environment Travel Concierge runs on. They judge every initiative by integration risk, reliability, auditability and total cost — and by whether it actually deflects calls and tickets across the partner agency network. They want one governed operating pattern, not ten point integrations.",
      context: [["Reports to", "Group COO"], ["Scope", "Platform · integration · governance"], ["Systems", "EasyBook · LyteAI · Easybooking · Airline Partner · KAF"], ["Owns (R)", "Reliability · security · cost"], ["Loudest in", "Governance · Cost"]],
      goals: [
    ...
    },
    {
      ...
      name: "AI Program Lead", role: "AI Lead · Client Travel Group",
      ...
      bio: "This AI program lead owns the agent stack — how Travel Orchestrator supervises specialist agents, how tools are gated, and how answers stay grounded. They care about evals, provenance, latency and human-in-the-loop far more than model demos. They want the agent to earn trust one auditable step at a time.",
      context: [["Reports to", "CIO"], ["Scope", "Agent orchestration · evals"], ["Systems", "Travel Orchestrator · specialist agents · KAF"], ["Owns (R)", "Guardrails · grounding · latency"], ["Loudest in", "AI · Controls"]],
      goals: [
      ...
      frustrations: [
        ...
        ["teal", "Latency that breaks flow", "If Travel Orchestrator stalls, the agent reaches for the old tools."]
      ],
    ...
    },
    {
      ...
      greet: "I run an independent agency. Show me how this makes my team faster and keeps the client mine — not Consumer Travel Portal's. Then we'll talk.",
      ...
      frustrations: [["red", "Disintermediation by Consumer Travel Portal", "If the brand site does it all, what's my agency for?"], ["amber", "Training overhead", "A new tool every season my staff can't absorb."], ["teal", "Thin, slow margins", "Time spent assembling is margin I never bill."]],
    ...
    },
    {
      ...
      context: [["Reports to", "Head of luxury"], ["Scope", "Bespoke itineraries"], ["Systems", "Signature Travel · Easybooking"], ["Owns (R)", "Design · client trust"], ["Loudest in", "Craft · Trust"]],
    ...
    },
    {
      ...
      name: "Enterprise Architect", role: "Enterprise Architect · Client Travel Group",
      ...
      bio: "Owns the reference architecture across Client Travel Group — how Travel Concierge, LyteAI, Easybooking, Airline Partner and the agency channels actually interconnect. Judges the design by clean contracts, clear ownership, event flow, observability and graceful failure — and by whether it stays coherent as the estate grows, rather than adding another silo.",
      context: [["Reports to", "CIO"], ["Scope", "Reference architecture · estate"], ["Systems", "KAF · EasyBook · LyteAI · Easybooking · Airline Partner"], ["Owns (R)", "Contracts · integration · standards"], ["Loudest in", "Architecture · Integration"]],
      goals: [["One coherent estate", "Travel Concierge as a layer on the existing systems — not a parallel stack."], ["Clean, versioned contracts", "Every agent↔system call typed, owned and replayable."], ["Graceful failure & observability", "Know what breaks, where, and how it degrades safely."]],
  ...
  var ROLE_SYS = {
    ...
    owner: "You are an independent travel-agency owner-operator. Judge everything by bookings won, staff hours saved, margin protected, and whether the customer relationship stays with your agency rather than Consumer Travel Portal. Blunt, commercial, a little wary of being disintermediated. Plain English; end with a practical question when it helps.",
  ...
  function openModal(id, view) {
    ...
    function profileHTML() {
      return '<div class="scp-prof">'
        ...
        + "</div>"
        + '<div class="pfoot">Characteristic composite for demo validation \u2014 Client Travel Group \u00b7 Kyndryl Agentic Framework. Not a record of a real person.</div>'
        + "</div>";
    }
