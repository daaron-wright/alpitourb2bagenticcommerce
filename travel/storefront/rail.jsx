    ...
    return (
      <aside className="sf-rail" data-screen-label={`${agent} rail`} aria-label={`${agent} orchestration panel`}>
        <div className="sf-rail-head">
          <span className="ic orchestrator"><SfInf size={15} /></span>
                ...
                {msgs.map((m, i) => (
                  m.role === "user"
                    ...
                    : <div className="sf-msg agent" key={i}>
                        <div className="who"><SfInf size={11} /> {m.skill && /^Travel Orchestrator/.test(m.skill) ? m.skill : `${agent} · ${m.skill || "Travel Orchestrator · supervisor"}`}</div>
